...
const FishCollection = (props) => {
	const FishCollectionClasses = classNames(["fishCollection"]);
	...
	return (
		<FishCollectionStyled className={FishCollectionClasses} {...props}>
			<h1>Fish Collection:</h1>
			<div className="FishCollectionFishContainer">{divs}</div>
