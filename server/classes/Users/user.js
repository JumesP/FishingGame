...
const getRandomFish = require("../../FishingLogic/Probability");
  ...
  constructor(name, username, age, tankID) {
    ...
    catchFish() {
        ...
        return openDatabase().then(async (db) => {
            await db.run('INSERT INTO Fish (Type, Weight, Length, Value, Health, TankID) VALUES (?, ?, ?, ?, ?, ?)', [type, weight, length, value, health, this.tankID]);
